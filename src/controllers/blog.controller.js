...
exports.updatePost = async (req, res) => {
  try {
    const { id } = req.params;
    const { title, content, category, cover_img, slug, tags, teaser, status, showOnHomePage } = req.body;
    console.log(showOnHomePage);
    ...
    if (showOnHomePage !== undefined) post.showOnHomePage = showOnHomePage;
